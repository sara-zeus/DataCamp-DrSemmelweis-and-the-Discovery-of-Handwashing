...
# Add the calculated proportion as a new column
yearly["proportion_deaths"] = yearly["deaths"] / yearly["births"]

# Extract the rows from Clinic 1 into clinic_1
clinic_1 = yearly[yearly["clinic"] == "clinic 1"]

# Extract the rows from Clinic 2 into clinic_2
...
# Calculate proportion of deaths per number of births and add to a new column
yearly["proportion_deaths"] = yearly["deaths"] / yearly["births"]

# Extract the rows from Clinic 1 and Clinic 2
clinic_1 = yearly[yearly["clinic"] == "clinic 1"]
clinic_2 = yearly[yearly["clinic"] == "clinic 2"]

# Plot proportion_deaths by year for the two clinics in a single plot
ax = clinic_1.plot(x="year", y="proportion_deaths", label="Clinic 1") 
ay= clinic_2.plot(x="year", y="proportion_deaths", label="Clinic 2", ax=ax)
...
# Define handwashing_start using pandas' to_datetime() function
...
# Create a plot of proportion_deaths for before_washing and after_washing
...
plt.legend(["Before Handwashing", "After Handwashing"])
plt.show()
...
# Initialize an empty list to store bootstrapped differences in means
boot_mean_diff = []

# Perform bootstrap analysis
for i in range(n_iterations):
    # Sample with replacement from before_proportion and after_proportion
    boot_before = np.random.choice(before_proportion, len(before_proportion), replace=True)
    boot_after = np.random.choice(after_proportion, len(after_proportion), replace=True)
